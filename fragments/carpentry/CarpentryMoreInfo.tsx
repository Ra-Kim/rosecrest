    ...
    <section className="py-16 lg:py-24 px-4 lg:px-8 bg-[#FBF7F4]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 mb-12 lg:mb-16 items-start">
          ...
          >
            <p>
              With Rosecrest Group Ltd, you’re not just investing in carpentry
              services;
            </p>
            <p>
              You’re partnering with a team that values integrity, reliability,
              and a commitment to transforming your home into a masterpiece.
              Discover the difference that expert craftsmanship can make—trust
              us for all your carpentry needs.
            </p>
          </div>
        </div>
        ...
        <div className="relative bg-linear-to-b from-[#262A6F] to-[#1A1D4F] rounded-3xl px-8 py-16 text-center overflow-hidden min-h-78">
          ...
          >
            Contact us today to discuss your carpentry needs with our expert
            team.
          </p>
          <Link
            href="/contact"
...
export default CarpentryMoreInfo;
