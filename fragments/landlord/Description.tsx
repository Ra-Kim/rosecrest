      ...
      <div className="grid lg:grid-cols-2 px-2 sm:px-0 py-12 lg:py-20 gap-8 items-center max-w-7xl mx-auto">
        ...
        <div className="flex flex-col justify-center">
          <Reveal animation="fade-right" duration={500}>
            <div className="mb-6">
              <span className={`${sourceSans.className} inline-block bg-[#262A6F1A] text-[#262A6F] text-sm h-8 font-medium px-4 py-2 rounded-full`}>
          ...
          <Reveal animation="fade-right" duration={600} delay={100}>
            <h2 className={`${sourceSans.className} text-base lg:text-2xl text-[#4A5565] mb-8 leading-tight w-[90%]`}>
