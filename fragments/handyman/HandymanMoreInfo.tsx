    ...
    <section className="py-16 lg:py-24 px-4 lg:px-8 bg-[#FBF7F4]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 mb-12 lg:mb-16 items-start">
          ...
          >
            <p>
              With Rosecrest Group Ltd, you have a dedicated team of
              professionals ready to assist with all your handyman needs.
            </p>
            <p>
              We bring experience, skill, and a commitment to excellence, so you
              can enjoy a home that’s both beautiful and functional. For
              handyman services you can count on, choose RPBS in London.
            </p>
          </div>
        </div>
        ...
        <div className="relative bg-linear-to-b from-[#262A6F] to-[#1A1D4F] rounded-3xl px-8 py-16 text-center overflow-hidden min-h-78">
          ...
          >
            Contact us to book a reliable handyman today.
          </p>
          <Link
            href="/contact"
...
export default HandymanMoreInfo;
