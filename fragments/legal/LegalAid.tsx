    ...
    <section className="max-w-7xl mx-auto py-6 px-4">
      <Reveal animation="fade-up" duration={600}>
        <div className="relative bg-linear-to-b from-[#262A6F] to-[#1A1D4F] rounded-[24px] px-8 py-20 text-center overflow-hidden">
          ...
          {/* Icon */}
          <Reveal animation="zoom-in" duration={500} delay={200}>
          ...
          <Reveal animation="fade-up" duration={500} delay={420}>
            <p className={`${sourceSans.className} relative z-10 text-white/80 text-base lg:text-lg leading-relaxed max-w-3xl mx-auto`}>
