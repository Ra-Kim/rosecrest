    ...
    <section className="py-16 lg:py-24 px-4 lg:px-8 bg-[#FBF7F4]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 mb-12 lg:mb-16 items-start">
          ...
          >
            <p>
              Are you looking for specialist cleaning services in London and the
              surrounding area?
            </p>
            <p>
              Then look no further than ROSECREST. With a wealth of experience,
              unmatched expertise, and an unwavering commitment to customer
              service, we are proud to be one of the go-to specialist, biohazard
              and deep cleaning companies in Surrey, Sussex, and beyond.
            </p>
          </div>
        </div>
